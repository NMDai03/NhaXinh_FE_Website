...
const UpdateMaterialPopUp = ({
  ...
  useEffect(() => {
    nhaxinhService.api.materialGetMaterialByIdDetail(materialId).then((res) => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      const response = await nhaxinhService.api.materialUpdateMaterialUpdate(
        materialId,
        {
          name: values.name,
...
export default UpdateMaterialPopUp;
